...
---
import SetIntervalSVG from '@site/static/svg/setinterval-interval.svg';
import SetTimeoutIntervalSVG from '@site/static/svg/settimeout-interval.svg';
